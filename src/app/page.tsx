      ...
      <main className="relative z-10">
        ...
        <section className="relative h-screen w-full overflow-hidden">
          ...
          <div className="absolute inset-0">
            <div className="w-full h-full bg-gradient-to-br from-background-dark via-surface-dark to-background-dark-end">
              {/* Abstract city visualization */}
              <div className="absolute inset-0 opacity-30">
                <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/10 rounded-full blur-3xl" />
                <div className="absolute bottom-1/3 right-1/4 w-64 h-64 bg-noor-gold/10 rounded-full blur-3xl" />
              </div>
            </div>
                ...
                <div className="flex items-center gap-4 mt-8 text-sm text-gray-300">
                  <div className="flex -space-x-3">
                    {[1, 2, 3].map((i) => (
                      <div
                        key={i}
                        className="w-10 h-10 rounded-full border-2 border-background-dark bg-gray-700"
                      />
                    ))}
                  </div>
