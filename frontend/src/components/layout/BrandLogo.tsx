 ...
 * Uses currentColor so parent text-color controls it. ( changing from balck to white)
 */
function OwlIcon({
  size = 32,
  className,
...
/**
 * LOGO SVG DOWNLOADED FROM https://www.svgrepo.com/svg/331957/owl-nightwatch
